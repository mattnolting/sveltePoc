...
<h1 class="pf-v6-c-title page-title"> Crafting Flexible Componentry:</h1><br> A New Approach to UI Development

<figure class="center pres">
  <img src="./src/lib/images/visual-comparison.png" />
</figure>
...
<div class="pf-v6-l-flex pf-m-direction-row">
   ...
   ```svelte
    <Component
      states={{ expanded: true, disabled: false }}
...
```svelte
<Component name="alert" states={{ expanded: isDetailVisible, disabled: !isInteractive }} modifiers={{ warning: isImportant }}>
